...
public class RefreshLayout extends ViewGroup {
    ...
    public void setRefreshHeader(View view) {
        if (view != null && view != refreshHeader) {
            ...
            if (layoutParams == null) {
                layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, Utils.dp2px(getContext(), 50));
    ...
    public void refreshComplete() {
        ...
        if (currentTargetOffsetTop == START_POSITION) {
            ...
            TextView tt = (TextView)headView.findViewById(R.id.head);
            tt.setText("刷新wanchden");
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            case MotionEvent.ACTION_DOWN:
                TextView ddd = (TextView)headView.findViewById(R.id.head);
                ddd.setText("下拉刷新");
          ...
          /*      if(yDiff >= totalDragDistance/1.0f){
                    TextView tv = (TextView)headView.findViewById(R.id.head);
                    tv.setText("松手刷新");
                }*/
    ...
    private void moveSpinner(float diff) {
        ...
        if (state == State.PULL && !isTouch && currentTargetOffsetTop > totalDragDistance && targetY <= totalDragDistance) {
            ...
            if (refreshListener != null) {
                TextView ff = (TextView)headView.findViewById(R.id.head);
                ff.setText("正在刷新");
